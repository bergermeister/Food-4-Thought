...
public class NotifierHelper implements IDebugSwitch {
    ...
    public static void sendNotification(NotificationManager notif, Class<?> activityToLaunch, String title, String msg, int numberOfEvents, boolean flashLed, boolean vibrate) {
        NotificationManager notifier = notif;
